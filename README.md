...
2. What is an event?
Things that happen when something is triggered. 
3. What is an event listener?
When a function waits for an event to happen. 
4. Why would we convert a NodeList into an Array?
We would convert a NodeList into an Array to make it easier to manipulate information.
5. What is a component?
Components is resuable html, css and java we can use to keep code DRY